      ...
      items: [
        {
          ...
          items: ["pages/dashboard", "pages/root"],
        },
        {
          type: "category",
          ...
          items: [
            {
              ...
              label: "Consommation",
              items: [
                "pages/consumption/consumption-kwh",
                "pages/consumption/consumption-euro",
              ],
            },
            "pages/production",
            "pages/bilan",
        ...
        },
        {
          ...
          label: "Contribuer",
          items: [
            "pages/contributes/offers",
            "pages/contributes/my-offers",
            "pages/contributes/new-offers",
          ],
        },
        {
          type: "category",
